...
|_. *Gender*|_. *Relationship status*|_. *Min*|_. *Max*|_. *Mean*|_. *Std.Dev.*|_. *Median*|_. *IQR*|_. *Skewness*|_. *Kurtosis*|
...
This report was generated with "R":http://www.r-project.org/ (2.14.0) and "rapport":http://al3xa.github.com/rapport/ (0.2) in 1.776 sec on x86&#95;64-unknown-linux-gnu platform.
