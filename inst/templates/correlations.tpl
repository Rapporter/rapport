...
Packages: ascii
Example: rapport('correlations', data=ius2008, vars=c('age', 'it.edu', 'it.leisure'))
...
<%
if (cor.matrix) {
    cm <- rp.round(cor(vars, na.rm = TRUE))
    d <- attributes(cm)
