...
In this case _one-sample t-test_ is carried out comparing the mean of the <%= p(x.label) %> variable, to a specified value of _<%= mu%>_. Confidence interval is set to <%= pct(ci.level * 100, 0) %>.
...
We will use _Shapiro-Wilk_, _Lilliefors_ and _Anderson-Darling_ tests to screen departures from normality in the (<%= p(x.label) %>) variable.
