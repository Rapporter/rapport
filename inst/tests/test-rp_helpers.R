...
test_that('should provide correct input definition', {
    ...
    expect_that(rapport:::check.type("number"), equals(list(type = 'number', limit = list(min = 1, max= 1), default = NULL, mandatory = FALSE)))
    expect_that(rapport:::check.type("string"), equals(list(type = 'string', limit = list(min = 1, max= 1), default = NULL, mandatory = FALSE)))
